        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('admin.leiloes.index') }}" class="mb-4">
                        <div class="flex">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            {{-- Adicionamos uma classe condicional para deixar a linha cinza se o leilão estiver inativo --}}
                            <tr class="@if($leilao->status === 'inativo') bg-gray-100 opacity-60 @endif">
                                ...
                                {{-- Coluna de Status com um 'badge' colorido --}}
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    {{-- Novo formulário para ATIVAR/DESATIVAR --}}
                                    <form class="inline-block ml-4" action="{{ route('admin.leiloes.toggleStatus', $leilao->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        {{-- O botão muda de cor e texto dependendo do status atual --}}
                                    ...
                                    {{-- Formulário para apagar, agora um pouco mais discreto --}}
                                    <form class="inline-block ml-4" action="{{ route('admin.leiloes.destroy', $leilao->id) }}" method="POST" onsubmit="return confirm('APAGAR É PERMANENTE! Tem certeza?');">
                                        @csrf
                                        @method('DELETE')
